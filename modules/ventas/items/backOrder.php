...
<body>
    <div class="container-fluid">
        <h4><img src="../../img/iconos/x24/backTime.png" alt=""> BackOrder test2</h4>
    </div>
    <hr>
    <div class="row">
        <!-- <div class="col-12">
                        ...
                        <div class="container">
                            ...
                            <div class="row">
                                <div class="d-flex mb-3">
                                    ...
                                    <div class="ps-2">
                                        <button id="btn_insertPartidaAdd" class="btn btn-success"><i class="fa-solid fa-plus"></i> Agregar</button>
                                    </div>
